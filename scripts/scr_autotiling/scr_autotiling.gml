...
function autotile_get_tile(obj,tile_width){
	...
	return return_tile(_up, _down, _left, _right, _upleft, _upright, _downleft, _downright)
}
/// @function autotile_get_tile_w_other(object, other_object, tile_width)
function autotile_get_tile_w_other(obj, other_obj, tile_width){
	var _up, _down, _left, _right, _upleft, _upright, _downleft, _downright
	_up = place_meeting(x,y-1,obj) or place_meeting(x,y-1,other_obj)
	_down = place_meeting(x,y+1,obj) or place_meeting(x,y+1,other_obj)
	_left = place_meeting(x-1,y,obj) or place_meeting(x-1,y,other_obj)
	_right = place_meeting(x+1,y,obj) or place_meeting(x+1,y,other_obj)
	_upleft = place_meeting(x-tile_width,y-tile_width,obj) or place_meeting(x-tile_width,y-tile_width,other_obj)
	_upright = place_meeting(x+tile_width,y-tile_width,obj) or place_meeting(x+tile_width,y-tile_width,other_obj)
	_downleft = place_meeting(x-tile_width,y+tile_width,obj) or place_meeting(x-tile_width,y+tile_width,other_obj)
	_downright = place_meeting(x+tile_width,y+tile_width,obj) or place_meeting(x+tile_width,y+tile_width,other_obj)
	return return_tile(_up, _down, _left, _right, _upleft, _upright, _downleft, _downright)
}
/// @function return_tile(_up, _down, _left, _right, _upleft, _upright, _downleft, _downright)
function return_tile(_up, _down, _left, _right, _upleft, _upright, _downleft, _downright){
	if (_up){
		if (_left){
			if (_right){
