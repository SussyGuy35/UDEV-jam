...
if(tick_timer <= 0) {
	...
	if(recalling) {
		var tent = instance_nearest(x,y,o_entity_player_building_fort);
		if(!instance_exists(tent)) tent = instance_nearest(x,y,o_entity_player_building_tent);
