...
str = ds_map_find_value(global.language_map, "STR_CONFIRM");
str_yes = ds_map_find_value(global.language_map, "STR_YES");
str_no = ds_map_find_value(global.language_map, "STR_NO");
